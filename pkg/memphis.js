...
export class WasmRepl {
  ...
  history_up() {
    wasm.wasmrepl_history_up(this.__wbg_ptr);
  }
  move_right() {
    wasm.wasmrepl_move_right(this.__wbg_ptr);
  }
  /**
   * @param {string} text
   */
  insert_text(text) {
    ...
    wasm.wasmrepl_insert_text(this.__wbg_ptr, ptr0, len0);
  }
  /**
   * @returns {string}
   */
  current_line() {
    ...
    let deferred1_1;
    try {
      const ret = wasm.wasmrepl_current_line(this.__wbg_ptr);
      deferred1_0 = ret[0];
      deferred1_1 = ret[1];
   ...
   */
  cursor_index() {
    const ret = wasm.wasmrepl_cursor_index(this.__wbg_ptr);
    return ret >>> 0;
  }
  history_down() {
  ...
  prompt() {
    ...
    let deferred1_1;
    try {
      const ret = wasm.wasmrepl_prompt(this.__wbg_ptr);
      deferred1_0 = ret[0];
      deferred1_1 = ret[1];
      return getStringFromWasm0(ret[0], ret[1]);
    } finally {
  ...
  interrupt() {
    wasm.wasmrepl_interrupt(this.__wbg_ptr);
  }
  move_left() {
    wasm.wasmrepl_move_left(this.__wbg_ptr);
  }
}
if (Symbol.dispose)
  WasmRepl.prototype[Symbol.dispose] = WasmRepl.prototype.free;
...
async function __wbg_init(module_or_path) {
  ...
  if (typeof module_or_path === "undefined") {
    module_or_path = new URL("memphis_bg.wasm", import.meta.url);
  }
  const imports = __wbg_get_imports();
